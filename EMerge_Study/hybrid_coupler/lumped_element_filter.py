...
for le in LEs:
    model.mesher.set_face_size(le, 0.2 * mm)
# Domain mesh refinement
model.mesher.set_domain_size(diel, 2 * mm)
model.mesher.set_domain_size(air, 5 * mm)

# Build mesh and view
# Build mesh and view with EMerge viewer only
model.generate_mesh()
