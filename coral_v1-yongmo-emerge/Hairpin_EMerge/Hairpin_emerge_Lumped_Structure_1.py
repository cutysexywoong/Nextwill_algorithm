...
m = em.Simulation('hairpin_filter_structure_1')
...
m.mesher.set_boundary_size(traces.face('+z'), MIN_EDGE * mm, growth_rate=10)
...
m.display.add_object(substrate)
m.display.add_object(traces)
